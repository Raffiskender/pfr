...
def load_view():
    ...
    Les données sont issues de Kaggle. Bien que n'étant plus disponibles sur la plateforme, les données brutes sont disponibles [ici](https://drive.google.com/drive/folders/11vW2AomLorVeJd3xdR83bEynd7gCxIsU?usp=drive_link) sur mon google drive personnel.
    ...
    st.markdown(
    """
    Ci dessous un extrait du dataframe. Plus de détail sur ces données <a href="/?page=dataset" target="_self">ici</a>
    ...
    Ci-dessous une analyse rapide de la répartition des données. Une analyse plus approfondie sur <a href="/?page=analysis" target="_self">cette page</a>
    """, unsafe_allow_html=True)
