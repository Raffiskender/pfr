...
def load():
    ...
    Les données sont issues de Kaggle. Bien que n'étant plus disponibles sur la plateforme, les données brutes sont disponibles <a class="link" href="https://drive.google.com/drive/folders/11vW2AomLorVeJd3xdR83bEynd7gCxIsU?usp=drive_link" target="_blank">sur mon google drive personnel</a>.
    ...
    * [les objectifs](#les-objectifs)
    ...
    Ci-dessous une analyse rapide de la répartition des données. Une analyse plus approfondie sur <a class="link" href="/eda" target="_self">cette page</a>
    """, unsafe_allow_html=True)
